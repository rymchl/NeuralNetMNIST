...
std::vector<std::vector<Pixel>> read_training_images() {
    return read_mnist_image_file<Pixel>(TRAINING_IMAGE_SET_PATH);
}
...
std::vector<std::vector<Pixel>> read_test_images() {
    return read_mnist_image_file<Pixel>(TEST_IMAGE_SET_PATH);
}
...
std::vector<Label> read_training_labels() {
    return read_mnist_label_file<Label>(TRAINING_LABELS_SET_PATH);
}
...
std::vector<Label> read_test_labels() {
    return read_mnist_label_file<Label>(TEST_LABELS_SET_PATH);
}
